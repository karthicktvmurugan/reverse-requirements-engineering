...
AC-002: When a settlement is cancelled after funds have been reserved, the reserved funds must be released back to the available balance within 30 seconds.

AC-003: Only users with the "settlement-approver" role can authorise a settlement above £50,000.
```
