...
- date, amount, quantity, eligibility, ownership, approval, submission, cancellation, expiry, or settlement concepts
...
- reconciliation logic — matching, balancing, netting, settlement reconciliation
