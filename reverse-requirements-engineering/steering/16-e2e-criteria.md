...
```text
## E2E-001: Standard Ticket Reservation — Happy Path

AC-E2E-001-01: When a reservation workspace is created and all parties complete preparation, the system must reserve funds from the nominated bank account before proceeding to reservation confirmation.

AC-E2E-001-02: The total amounts across all add ons must equal the total funds reserved, with no unaccounted remainder after reservation execution.

AC-E2E-001-03: If the trip is rejected after funds have been reserved, the system must release all reserved funds within 30 seconds and notify all affected parties.

AC-E2E-001-04: The reservation cannot proceed to execution unless all prerequisite stages (preparation, approval, funds reservation, ticket reservation) have completed successfully in order.
```
